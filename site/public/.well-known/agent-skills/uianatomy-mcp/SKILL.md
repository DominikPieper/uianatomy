...
- `get_component_section({ id, sections: [...] })` — one or more sections in a single call. Valid sections: `anatomy`, `axes`, `mismatches`, `mistakes`, `frameworkMap`, `tokens`, `motion`, `responsive`, `transitions`, `events`, `whenToUse`, `a11yAcceptance`, `propertyMap`, `formIntegration`, `i18n`, `performance`, `sources`.
